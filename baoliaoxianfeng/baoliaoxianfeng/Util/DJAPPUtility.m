...
+ (DJCoreTextLinkData *)touchLinkInView:(UIView *)view atPoint:(CGPoint)point data:(DJCoreTextData *)data; {
    ...
    DJCoreTextLinkData * foundLink = [self linkAtIndex:idx linkArray:data.linkArray];
    return foundLink;
}
...
+ (DJCoreTextLinkData *)linkAtIndex:(CFIndex)i linkArray:(NSArray *)linkArray {
    DJCoreTextLinkData *link = nil;
    for (DJCoreTextLinkData *data in linkArray) {
